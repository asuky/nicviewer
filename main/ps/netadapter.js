const netadapter = String.raw`
### Join Func
### https://code.i-harness.com/ja/q/1c35f5
...
$netadapters = Get-NetAdapter | Select-Object InterfaceIndex, InterfaceDescription, Status, MacAddress

$ipaddresses = Get-NetIPAddress | Select-Object InterfaceIndex, IPAddress

$joined = ""
$netadapters | LeftJoin $ipaddresses InterfaceIndex | foreach {
    $tmp = $_ | ConvertTo-Json -compress
    $joined += $tmp + ","
}
